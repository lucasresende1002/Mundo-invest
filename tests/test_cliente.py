...
# Ref: https://developers.pipefy.com/reference/mutations/updateCardField
# ──────────────────────────────────────────────────────────────────────────────
...
def build_update_card_field_variables(
    ...
    """
    Monta as variáveis para a mutation updateCardField conforme a spec do Pipefy.
    Atualiza um único campo por chamada.
    """
    return {
        "input": {
            "card_id": card_id,
...
# ──────────────────────────────────────────────────────────────────────────────
# Funções de envio (simuladas / dry-run)
# ──────────────────────────────────────────────────────────────────────────────
